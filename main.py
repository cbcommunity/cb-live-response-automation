...
if __name__ == '__main__':
    ...
    config_data.read(os.path.join(os.path.expanduser('~'), '.carbonblack', 'credentials.response'))

    cb_server = config_data.get('default', 'url')
    token = config_data.get('default', 'token')
